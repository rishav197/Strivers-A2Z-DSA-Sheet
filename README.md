...
|S.No. | Problem | Approach/Logic used | Level | Link | Solution |         
|------|---------|---------------------|-------|------|----------|
| 1 | Number of Provinces (leetcode) | by using any of these traversal BFS/DFS and a visited map | Medium | [view](https://leetcode.com/problems/number-of-provinces/description/) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/num-of-provinces-lc.cpp) |
| 2 | Connected Components Problem in Matrix (No. of provinces) | by using any of these traversal BFS/DFS and a visited map | Medium | [view](https://www.geeksforgeeks.org/problems/number-of-provinces/1) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/num-of-provinces-gfg.cpp) |
| 3 | Rotten Oranges | Using BFS, Visited grid and queue of pair {{row,col},time} | Medium | [view](https://leetcode.com/problems/rotting-oranges/) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/rotten-oranges.cpp) |
...
| 7 | 0/1 matrix | Based on BFS, Using Queue of pair of (row,col) and step(distance), vis[][] and dist[][] grid  | Medium | [view](https://leetcode.com/problems/01-matrix/description/) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/zero-one-matrix-lc.cpp) |
| 7 | Distance of nearest cell having 1 (Same as 0/1 matrix problem on LC) | Based on BFS, Using Queue of pair of (row,col) and step(distance), vis[][] and dist[][] grid | Medium | [view](https://www.geeksforgeeks.org/problems/distance-of-nearest-cell-having-1-1587115620/1) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/zero-one-matrix-gfg.cpp) |
| 8 | Surrounded Regions (dfs) |  | Medium | [view](https://leetcode.com/problems/surrounded-regions/description/) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec2-Problems-on-BFS-DFS/surrounded-regions-dfs-lc.cpp) |
...
| 6 | Find Eventul Safe States | using topoSort | Medium | [view](https://leetcode.com/problems/find-eventual-safe-states/description/) | [view](https://github.com/rishav197/Strivers-A2Z-DSA-Sheet/blob/main/Graphs/Lec3-TopoSort-and-Problems/find-eventual-safe-states.cpp) |
